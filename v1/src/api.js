/* PATCH: Input-Loop-Logic#v3.2 ( api~retry-logic ) */
...
export const DATA_SERVICE = {
    ...
    // UPDATE PENTING DI SINI: Parameter retryCallback
    async fetchCustomAddress(address, renderCallback, startLiveUpdate, retryCallback) {
        ...
        try {
            ...
            setTimeout(() => { 
                STATE.error = null; 
                retryCallback(); // Retry juga jika API error
            }, 2000);
        }
    },
