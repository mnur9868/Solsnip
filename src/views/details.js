/* PATCH: Details-Classic-Fixed#v4.2 ( view~details-fixed-restore ) */
...
export const drawDetails = () => {
    ...
    const W = 78; // Lebar tetap, tidak berubah saat resize
    const P = " ".repeat(Math.max(0, Math.floor((totalW - W) / 2))); // Padding agar tetap di tengah
